...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ironBeam = __webpack_require__(1);

	var IronBeam = _interopRequireWildcard(_ironBeam);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IronTree = __webpack_require__(8);
	var EventEmitter = function () {
	    ...
	    EventEmitter.prototype.addNewListener = function (listener, method) {
	        ...
	        if (++count > this.maxListeners) {
	            ...
	            console.error('(iron-beam) warning: possible EventEmitter memory ' + 'leak detected. %d %s listeners added. ' + 'Use emitter.setMaxListeners() to increase limit.', count, listener.event);
	            console.trace();
	        }
	        ...
	        async.eachSeries(intercepts, function (intercept, cb) {
	            if (!stop) {
	                if (!_.isUndefined(intercept.interceptors[method])) {
	                    intercept.interceptors[method].apply(_this, [function () {
	                        stop = true;
	                        cb(null);
	    ...
	    EventEmitter.prototype.allAnnotatedListeners = function (anno, eventName) {
	        ...
	        return _.filter(listeners, function (l) {
	            ...
	            return _.every(_.keys(anno), function (k) {
	                return !_.isUndefined(l.annotation[k]) && _.isEqual(l.annotation[k], anno[k]);
	            });
	        });
	    };
